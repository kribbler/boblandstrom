...
function bkb_ques_front_end_form($atts) {
   ...
   $bwl_kb_categories_counter = get_categories('post_type=bwl_kb&taxonomy=bkb_category&orderby=name&order=ASC');
    ...
    $bwl_kb_categories = wp_dropdown_categories( 'post_type=bwl_kb&show_option_none='.__('- Select Category -', 'bwl-kb') . '&tab_index=4&taxonomy=bkb_category&echo=0&hide_empty=0' );
    ...
    if ( isset($bkb_options['bkb_display_question_submission_form']) && $bkb_options['bkb_display_question_submission_form'] == 1 ) {
