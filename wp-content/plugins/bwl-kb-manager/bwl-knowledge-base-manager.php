...
* Plugin URI: http://codecanyon.net/item/bwl-knowledge-base-manager/7972812?ref=xenioushk
...
Class BWL_KB_Manager{
    ...
    function __construct() {
        ...
        define( "BWL_KB_PLUGIN_VERSION", '1.0.5');
    ...
    function enqueue_plugin_scripts(){
        ...
        if ( ! is_admin()) {
            ...
            if( ! isset( $bkb_data['bkb_fontawesome_status'] ) || $bkb_data['bkb_fontawesome_status'] == 1 ) {
                wp_enqueue_style( 'bkb-font-awesome-styles' , plugins_url( 'css/font-awesome.min.css' , __FILE__ ) );
            }

            $bkbm_custom_styles_url = plugins_url('css/bkbm-custom-styles.css', __FILE__);
            
            if( BWL_KB_PLUGIN_PRODUCTION_STATUS == 1 ) {
                $bkbm_custom_styles_url = plugins_url('css/bkbm-custom-styles.min.css', __FILE__);
            }
        ...
        if( is_admin() ){
            ...
            if( isset( $_GET['post_type'] ) &&  $_GET['post_type'] == 'bwl_kb' ) {
                wp_enqueue_style( 'bkb-admin-font-awesome-styles' , plugins_url( 'css/font-awesome.min.css' , __FILE__ ) );
            }
            ...
            wp_register_script( 'bkb-admin-mutiple-select-script', plugins_url( 'tinymce/js/jquery.multiple.select.js' , __FILE__ ) , array( 'jquery'), '', TRUE );
