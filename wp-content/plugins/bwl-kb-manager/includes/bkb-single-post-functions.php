...
//        $bkb_post_breadcrumb = bkb_get_post_breadcrumb();
        ...
        if( current_user_can( 'edit_post', $postID ) ) {
                ...
                $bkb_edit_link_interface = '<span class="fa fa-edit"></span> <a href="'.$bkb_edit_link.'" target="_blank" title="'.get_the_title().'">' . __('Edit', 'bwl-kb') . '</a>';
        }
...
if ( ! function_exists('bkb_get_post_breadcrumb') ) {
        
    function bkb_get_post_breadcrumb() {
        ...
        $bkb_home = '<a href="'.get_home_url().'">Home</a>';
        
        $bkb_post_cat = "";
       
        $bkb_post_title = get_the_title();
        
        return $breadcrumb_string = $bkb_home .' &rarr; '. $bkb_post_cat . $bkb_post_title;
        
    }
        
} else {
        
        echo "bkb_get_post_breadcrumb - Function already exist!";
...
function get_bkb_attachment2( $id ) {
    ...
    if ( sizeof($get_bkb_attachment_ids) > 0 ) {
        ...
        foreach ($get_bkb_attachment_ids as $attachment_post_id){
            ...
            $bkb_file_attachment_string .='<li>';
                ...
                $bkb_file_attachment_string .= '<a href="'.home_url().'/wp-content/uploads/' . $get_bkb_attachment_url .'" target="_blank">' . __(' Your Download - ', 'bwl-kb') . $counter . '</a>';
